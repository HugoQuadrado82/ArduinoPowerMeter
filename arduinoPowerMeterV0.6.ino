/*
  Developed by Hugo Quadrado for tecnovlogger (c) 2020
  v 0.6 RC
*/
...
void calculateThePower(){
      ...
      //P(W) = PF × I(A) × V(V)
      power = PF * currentDraw * VOLTAGE_AC; //Watts in real time
...
void writeEnergyToDisplay(){
      ...
      lcd.setCursor(2,2); lcd.print(VOLTAGE_AC);
      ...
      lcd.setCursor(2,3); lcd.print(currentDraw);
